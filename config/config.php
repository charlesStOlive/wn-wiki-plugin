...
return [
    'packages' => [
        'illuminated/laravel-wikipedia-grabber' => [
            'providers' => [
                '\Illuminated\Wikipedia\WikipediaGrabberServiceProvider',
            ],
            'aliases' => [
                'Wikipedia' => '\Illuminated\Wikipedia\Wikipedia',
            ],
            'config_namespace' => 'wikipedia-grabber',
            'config' => [
                /*
                |--------------------------------------------------------------------------
                | Output Format
                ...
                */
                ...
                'boring_sections' => [
                    ...
                    'fr' => [
                        ...
                        'Pour en savoir plus',
                        'Autre lecture/écoute/visionnage',
                        'Littérature',
                        'Liens d\'actualités',
                        'Remarques',
                        'Notes et références',
